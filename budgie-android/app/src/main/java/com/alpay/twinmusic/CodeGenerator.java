...
public class CodeGenerator {
    ...
    public static final String ADD_NOTE_D = "addNote('D', 1)";
    public static final String ADD_NOTE_E = "addNote('E', 1)";
    public static final String ADD_NOTE_F = "addNote('F', 1)";
    public static final String ADD_NOTE_G = "addNote('G', 1)";
    ...
    public static final String LOOP_UP = "increaseLoop()";
    public static final String LOOP_DOWN = "decreaseLoop()";
    public static final String BPM_UP = "increaseBPM()";
